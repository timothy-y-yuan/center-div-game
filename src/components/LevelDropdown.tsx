...
export default function LevelDropdown({ levels, currentLevelIndex, completedLevels, failedLevels, onLevelSelect }: LevelDropdownProps) {
      ...
      {isOpen && createPortal(
        <div
          ...
          style={{
            ...
            scrollbarWidth: 'thin',
            scrollbarColor: actualTheme === 'dark' ? '#4B5563 #1F2937' : '#9CA3AF #F3F4F6'
          }}
        >
