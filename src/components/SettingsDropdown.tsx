...
export default function SettingsDropdown({ onResetProgress }: SettingsDropdownProps) {
  ...
  const getThemeLabel = (themeType: 'light' | 'dark' | 'system') => {
    switch (themeType) {
      ...
      case 'system': return `Auto (${systemTheme})`
      default: return 'Auto'
    }
  }
            ...
            {!showResetConfirm ? (
              ...
              <div className={`p-3 rounded-lg ${
                ...
                <div className={`text-xs mb-3 ${
                  ...
                  This will permanently delete all your progress, completed levels, and scores.
                </div>
