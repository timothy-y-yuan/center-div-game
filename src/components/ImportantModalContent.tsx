  ...
  return (
    <div className='p-6 relative'>
      ...
      <div className='relative z-10'>
        <p
          className='text-xl font-bold leading-relaxed mb-4 animate-pulse text-red-800 dark:text-red-200'
          style={{
        ...
        >
          ...
          Using{' '}
          <code className='px-3 py-2 rounded-md font-bold text-lg animate-bounce bg-red-100 dark:bg-red-900 text-red-900 dark:text-red-100 border-2 border-red-500 dark:border-red-400'>
            !important
          </code>{' '}
        ...
        <div className='p-4 rounded-lg mb-4 border-l-4 border-orange-500 bg-orange-50 dark:bg-orange-900/30'>
        ...
        <div className='p-3 rounded-lg mb-6 bg-gray-100 dark:bg-gray-800/50'>
        ...
        <div className='flex justify-center gap-3'>
          <button
            ...
            className='px-8 py-4 rounded-lg font-bold text-xl transition-all duration-200 transform hover:scale-110 animate-pulse bg-gradient-to-r from-red-500 via-red-600 to-red-500 hover:from-red-400 hover:to-red-500 dark:from-red-600 dark:via-red-500 dark:to-red-700 dark:hover:from-red-500 dark:hover:to-red-600 text-white shadow-lg hover:shadow-red-500/50'
          >
