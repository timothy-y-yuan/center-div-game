...
describe('ConfettiEffect Component', () => {
  ...
  it('should not render when isVisible is false', () => {
    const { container } = render(<ConfettiEffect isVisible={false} onComplete={vi.fn()} />)
  ...
  it('should handle isVisible state changes', () => {
    const { container, rerender } = render(<ConfettiEffect isVisible={false} onComplete={vi.fn()} />)
  ...
  it('should clean up when isVisible becomes false', () => {
    const { container, rerender } = render(<ConfettiEffect isVisible={true} onComplete={vi.fn()} />)
  ...
  it('should clear timers on unmount', () => {
    ...
    const { unmount } = render(<ConfettiEffect isVisible={true} onComplete={vi.fn()} />)
