...
describe('Enhanced ImportantModal - Stage 2', () => {
  ...
  it('should render the enhanced modal with dramatic styling when open', () => {
    ...
    renderWithTheme(
      <ImportantModal isOpen={true} onClose={mockOnClose} />
    );
    ...
    expect(screen.getByText(/sledgehammer to hang a picture/)).toBeInTheDocument();
  ...
  it('should show educational content sections', () => {
    ...
    expect(screen.getByText(/The whole point of this game is to learn/)).toBeInTheDocument();
  ...
  it('should not render when closed', () => {
    ...
    renderWithTheme(
      <ImportantModal isOpen={false} onClose={mockOnClose} />
    );
  ...
  it('should show enhanced educational content about CSS specificity', () => {
    ...
    expect(screen.getByText(/more maintainable and elegant/)).toBeInTheDocument();
